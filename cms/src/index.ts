...
const privacyPageSeed = {
  hero_banner: {
    badge: 'LEGAL',
    title: 'Privacy Policy',
  },
  body: `[Your business name] is committed to providing quality services to you and this policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.
...
Sensitive Information is defined in the Privacy Act to include information such as an individual's racial or ethnic origin, political opinions, membership of a political association, religious or philosophical beliefs, membership of a trade union or other professional body, criminal record or health information.
...
Where reasonable and practicable to do so, we will collect your Personal Information only from you. However, in some circumstances we may be provided with information by third parties. In such a case we will take reasonable steps to ensure that you were made aware of the information provided to us by the third party.
...
It is important to us that your Personal Information is up to date. We will take reasonable steps to make sure that your Personal Information is accurate, complete and up-to-date. If you find that the information we hold is not up to date or is inaccurate, please advise us as soon as practicable so we can update our records and ensure we can continue to provide quality services to you.
...
[Your business phone number]`,
  seo: {
    title: 'Privacy Policy — Care Collaborator',
    description:
      'How Care Collaborator collects, uses, discloses, and protects your Personal Information under the Australian Privacy Principles.',
    no_index: false,
  },
};
...
async function seedPrivacyPage(strapi: Core.Strapi) {
  await upsertSingle(strapi, 'api::privacy-page.privacy-page', privacyPageSeed, 'Privacy Page');
}
