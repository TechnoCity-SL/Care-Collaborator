...
export async function fetchHomePage(draft = false): Promise<HomePageDTO> {
  const response = await strapiGet<{ data: HomePageDTO }>(
    '/home-page' +
      ...
      '&populate[video_section][populate][video_file][fields][0]=url' +
      '&populate[video_section][populate][video_file][fields][1]=alternativeText' +
      '&populate[video_section][populate][video_file][fields][2]=width' +
      '&populate[video_section][populate][video_file][fields][3]=height' +
      ...
      '&populate[features_section][populate][features][fields][0]=title' +
      '&populate[features_section][populate][features][fields][1]=description' +
      '&populate[features_section][populate][features][fields][2]=icon_key' +
      '&populate[steps_section][populate][steps][fields][0]=title' +
      '&populate[steps_section][populate][steps][fields][1]=description' +
